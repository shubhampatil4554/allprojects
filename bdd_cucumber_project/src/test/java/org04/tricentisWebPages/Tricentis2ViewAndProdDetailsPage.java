...
public class Tricentis2ViewAndProdDetailsPage extends SeleniumUtility {
	...
	@FindBy(xpath = "//div[h2[@class='product-title'][a[text()='14.1-inch Laptop']]]/div[3]/div[2]/input")
	...
	/*
	 * public void getProductDetails() { for(int i=0;i<10;i++) {
	 * driver.findElement(By.xpath("//body")).sendKeys(Keys.ARROW_DOWN); } for (int
	 * i = 0; i < productList.size(); i++) { WebElement element =
	 * productList.get(i); if (i == 1) { clickOnElement(element); break; } } }
	 */
