...
public class Etrain extends SeleniumUtil{
	WebDriver driver;
	@Test
	public void testEtrain1() throws InterruptedException {
	    driver = setUp("edge", "https://erail.in/");
	...
	@Test
	public void testetrain2() throws InterruptedException {
		...
		clickOnElement(driver.findElement(By.xpath("//input[@value='Get Trains']")));
