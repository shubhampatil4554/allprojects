...
public class TestUserWithPoJoPropertiesFile {
	...
	public void testUserCreation() {
		Response res=UserEndPoints2.createUser(getUserPayload);
		Assert.assertEquals(res.getStatusCode(), 200);
	}
	@Test(priority=2)
	public void testGetCreatedUser() {
		Response res=UserEndPoints2.getUser(getUserPayload.getUsername());
		Assert.assertEquals(res.getStatusCode(), 200);
	}
	@Test(priority=3)
	public void testUserUpdate() {
		...
		getUserPayload.setEmail(faker.internet().safeEmailAddress());
		//update user details
		Response res=UserEndPoints2.updateUser(getUserPayload.getUsername(), getUserPayload);
		Assert.assertEquals(res.getStatusCode(), 200);
		//validate user details are updated or not
		Response resAfterUpdate=UserEndPoints2.getUser(getUserPayload.getUsername());
	...
	public void testUserDeletion() {
		Response res=UserEndPoints2.deleteUser(getUserPayload.getUsername());
		Assert.assertEquals(res.getStatusCode(), 200);
	}
